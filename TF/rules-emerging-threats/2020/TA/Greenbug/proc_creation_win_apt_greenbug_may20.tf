resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_apt_greenbug_may20" {
  name                       = "proc_creation_win_apt_greenbug_may20"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Greenbug Espionage Group Indicators"
  description                = "Detects tools and process executions used by Greenbug in their May 2020 campaign as reported by Symantec Reference: https://github.com/SigmaHQ/sigma/blob/master/rules-emerging-threats/2020/TA/Greenbug/proc_creation_win_apt_greenbug_may20.yml - Unlikely | Source: https://github.com/SigmaHQ/sigma/blob/master/rules-emerging-threats/2020/TA/Greenbug/proc_creation_win_apt_greenbug_may20.yml"
  severity                   = "High"
  query                      = <<QUERY
DeviceProcessEvents
