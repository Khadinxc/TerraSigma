resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_apt_wocao" {
  name                       = "proc_creation_win_apt_wocao"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Operation Wocao Activity"
  description                = "Detects activity mentioned in Operation Wocao report Reference: https://github.com/SigmaHQ/sigma/blob/master/rules-emerging-threats/2019/TA/Operation-Wocao/proc_creation_win_apt_wocao.yml - Administrators that use checkadmin.exe tool to enumerate local administrators | Source: https://github.com/SigmaHQ/sigma/blob/master/rules-emerging-threats/2019/TA/Operation-Wocao/proc_creation_win_apt_wocao.yml"
  severity                   = "High"
  query                      = <<QUERY
DeviceProcessEvents
