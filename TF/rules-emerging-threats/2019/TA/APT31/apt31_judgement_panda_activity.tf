resource "azurerm_sentinel_alert_rule_scheduled" "apt31_judgement_panda_activity" {
  ...
  description                = "Detects APT31 Judgement Panda activity as described in the Crowdstrike 2019 Global Threat Report - Unlikely | Source: https://github.com/SigmaHQ/sigma/blob/master/rules-emerging-threats/2019/TA/APT31/apt31_judgement_panda_activity.tf"
  severity                   = "High"
  query                      = <<QUERY
DeviceProcessEvents
