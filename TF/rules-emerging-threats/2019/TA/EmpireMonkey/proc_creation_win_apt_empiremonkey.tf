resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_apt_empiremonkey" {
  ...
  query                      = <<QUERY
DeviceProcessEvents
| where ProcessCommandLine contains "/e:jscript" and ProcessCommandLine contains "\\Local\\Temp\\Errors.bat"
QUERY
