resource "azurerm_sentinel_alert_rule_scheduled" "mint_sandstorm_log4j_wstomcat_process_execution" {
  ...
  description                = "Detects Log4J Wstomcat process execution as seen in Mint Sandstorm activity | Source: https://github.com/SigmaHQ/sigma/blob/master/rules-emerging-threats/2023/TA/Mint-Sandstorm/mint_sandstorm_log4j_wstomcat_process_execution.tf"
  severity                   = "High"
  query                      = <<QUERY
DeviceProcessEvents
