resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_susp_script_exec_from_compressed_parent" {
  ...
  description                = <<DESC
    ...
    Reference: https://github.com/SigmaHQ/sigma/blob/master/rules-threat-hunting/windows/process_creation/proc_creation_win_susp_script_exec_from_compressed_parent.yml
