resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_susp_execution_from_guid_folder_names" {
  ...
  description                = <<DESC
    ...
    Reference: https://github.com/SigmaHQ/sigma/blob/master/rules-threat-hunting/windows/process_creation/proc_creation_win_susp_execution_from_guid_folder_names.yml
