resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_remote_access_tools_action1_code_exec_and_remote_sessions" {
  ...
  description                = <<DESC
    ...
    Reference: https://github.com/SigmaHQ/sigma/blob/master/rules-threat-hunting/windows/process_creation/proc_creation_win_remote_access_tools_action1_code_exec_and_remote_sessions.yml
