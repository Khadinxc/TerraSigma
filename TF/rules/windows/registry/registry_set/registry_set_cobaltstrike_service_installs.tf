resource "azurerm_sentinel_alert_rule_scheduled" "registry_set_cobaltstrike_service_installs" {
  name                       = "registry_set_cobaltstrike_service_installs"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Potential CobaltStrike Service Installations - Registry"
  description                = "Detects known malicious service installs that appear in cases in which a Cobalt Strike beacon elevates privileges or lateral movement. Reference: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/registry/registry_set/registry_set_cobaltstrike_service_installs.yml - Unlikely | Source: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/registry/registry_set/registry_set_cobaltstrike_service_installs.yml"
  severity                   = "High"
  query                      = <<QUERY
