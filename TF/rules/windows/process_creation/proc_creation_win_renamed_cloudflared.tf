resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_renamed_cloudflared" {
  name                       = "proc_creation_win_renamed_cloudflared"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Renamed Cloudflared.EXE Execution"
  description                = "Detects the execution of a renamed \"cloudflared\" binary. Reference: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/proc_creation_win_renamed_cloudflared.yml | Source: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/proc_creation_win_renamed_cloudflared.yml"
  severity                   = "High"
  query                      = <<QUERY
DeviceProcessEvents
