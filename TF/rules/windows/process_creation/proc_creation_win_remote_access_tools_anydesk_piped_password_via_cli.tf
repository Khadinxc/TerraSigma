resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_remote_access_tools_anydesk_piped_password_via_cli" {
  ...
  description                = <<DESC
    ...
    Reference: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/proc_creation_win_remote_access_tools_anydesk_piped_password_via_cli.yml
