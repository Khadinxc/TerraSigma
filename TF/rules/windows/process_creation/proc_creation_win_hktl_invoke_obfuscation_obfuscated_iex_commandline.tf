resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_hktl_invoke_obfuscation_obfuscated_iex_commandline" {
  ...
  description                = <<DESC
    ...
    Reference: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/proc_creation_win_hktl_invoke_obfuscation_obfuscated_iex_commandline.yml
  DESC
  severity                   = "High"
  query                      = <<QUERY
DeviceProcessEvents
