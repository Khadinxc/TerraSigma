resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_wget_download_susp_file_sharing_domains" {
  ...
  description                = "Detects potentially suspicious file downloads from file sharing domains using wget.exe Reference: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/proc_creation_win_wget_download_susp_file_sharing_domains.yml | Source: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/proc_creation_win_wget_download_susp_file_sharing_domains.yml"
  severity                   = "High"
  query                      = <<QUERY
DeviceProcessEvents
