resource "azurerm_sentinel_alert_rule_scheduled" "proc_creation_win_curl_download_susp_file_sharing_domains" {
  name                       = "proc_creation_win_curl_download_susp_file_sharing_domains"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Suspicious File Download From File Sharing Domain Via Curl.EXE"
  description                = "Detects potentially suspicious file download from file sharing domains using curl.exe Reference: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/proc_creation_win_curl_download_susp_file_sharing_domains.yml | Source: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/proc_creation_win_curl_download_susp_file_sharing_domains.yml"
  severity                   = "High"
  query                      = <<QUERY
DeviceProcessEvents
