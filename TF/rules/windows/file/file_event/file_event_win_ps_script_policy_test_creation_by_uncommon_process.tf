resource "azurerm_sentinel_alert_rule_scheduled" "file_event_win_ps_script_policy_test_creation_by_uncommon_process" {
  ...
  description                = <<DESC
    ...
    Reference: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/file/file_event/file_event_win_ps_script_policy_test_creation_by_uncommon_process.yml
  DESC
  severity                   = "Medium"
  query                      = <<QUERY
DeviceFileEvents
