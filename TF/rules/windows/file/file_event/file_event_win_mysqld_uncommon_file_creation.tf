resource "azurerm_sentinel_alert_rule_scheduled" "file_event_win_mysqld_uncommon_file_creation" {
  name                       = "file_event_win_mysqld_uncommon_file_creation"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Uncommon File Creation By Mysql Daemon Process"
  description                = "Detects the creation of files with scripting or executable extensions by Mysql daemon. Which could be an indicator of \"User Defined Functions\" abuse to download malware. Reference: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/file/file_event/file_event_win_mysqld_uncommon_file_creation.yml | Source: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/file/file_event/file_event_win_mysqld_uncommon_file_creation.yml"
  severity                   = "High"
  query                      = <<QUERY
DeviceFileEvents
