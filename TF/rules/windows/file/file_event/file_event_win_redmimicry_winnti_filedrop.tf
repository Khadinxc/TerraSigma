resource "azurerm_sentinel_alert_rule_scheduled" "file_event_win_redmimicry_winnti_filedrop" {
  name                       = "file_event_win_redmimicry_winnti_filedrop"
  log_analytics_workspace_id = var.workspace_id
  display_name               = "Potential Winnti Dropper Activity"
  description                = "Detects files dropped by Winnti as described in RedMimicry Winnti playbook Reference: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/file/file_event/file_event_win_redmimicry_winnti_filedrop.yml | Source: https://github.com/SigmaHQ/sigma/blob/master/rules/windows/file/file_event/file_event_win_redmimicry_winnti_filedrop.yml"
  severity                   = "High"
  query                      = <<QUERY
DeviceFileEvents
